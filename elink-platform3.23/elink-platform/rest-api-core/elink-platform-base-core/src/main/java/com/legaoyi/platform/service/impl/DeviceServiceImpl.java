...
public class DeviceServiceImpl implements DeviceService {
    ...
    public List<?> queyUnbindDevice(String enterpriseId, String groupId, int pageSize, int pageNo) throws Exception {
        String sql = "SELECT id,name as name,enterprise_id as enterpriseId FROM device a where not exists (SELECT id FROM car b WHERE a.id = b.device_id ) AND enterprise_id = ? ";

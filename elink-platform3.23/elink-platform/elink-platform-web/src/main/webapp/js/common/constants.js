//微服务部署时使用
//var management_api_server_servlet_path ="/management";
//var message_api_server_servlet_path ="/message";
//var lbs_api_server_servlet_path ="/lbs";
//var report_api_server_servlet_path ="/report";
//var officerCar_api_server_servlet_path ="/officers/car";
//var bus_api_server_servlet_path = "/bus";
...
devicefaultAlarmInfoMap.put(8, "终端主电源已拆除");
...
devicefaultAlarmInfoMap.put(15, "ADAS前车碰撞预警");
devicefaultAlarmInfoMap.put(16, "SD卡异常");
...
carAlarmInfoMap.put(40, "急加速");
carAlarmInfoMap.put(41, "急刹车");
...
//苏标报警,高级驾驶辅助系统报警信息
var adasAlarmDesc = ["前向碰撞报警","车道偏离报警","车距过近报警","行人碰撞报警","频繁变道报警","道路标识超限报警","障碍物报警","用户自定义报警","用户自定义报警","道路标志识别事件","主动抓拍事件","急加速","急减速","急转弯","碰撞唤醒","用户自定义报警","用户自定义报警","碰撞预警"];
//驾驶员状态监测系统报警信息
...
//设备故障类告警,连续相同报警只存储一次
var device_fault_alarm="1000000010001111111110000";

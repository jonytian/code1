...
<body>
	...
	<div id="edit-dlg" title="车辆级别信息" class="simple-dialog" style="width: 550px; height: 200px;">
	<form id="edit-frm" method="post">
		...
		<div class="message_con">
			<label>级别代码：</label><input name="code" id="edit-frm-code" maxlength="2" type="text" class="required number"><span class="must">*</span>
		</div>
		<div class="message_con">
			<label>级别名称：</label><input name="content" id="edit-frm-content" maxlength="20" type="text" class="required"><span class="must">*</span>
		</div>
	...
	<script type="text/javascript" src="<c:url value='/js/dictionary/carLevelList.js'/>"></script>
</body>
</html>
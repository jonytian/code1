...
<header id="header" class="header left">
    ...
    <div class="right nav">
        ...
        <div id="header-user-info" class="right text_right">
        	  <div id="todo_alarm_box" style="disply:none;"><a href='javascript:void(0);' onclick='showTodoAlarm();' title="您有重要报警未处理"><img style="height:50px;margin-top:-10px;" src="<c:url value='/img/alarm.gif'/>"></div>

...
<div id="edit-dlg" title="设备信息" class="simple-dialog" style="width:650px; height:400px;">
	<form id="edit-frm" method="post">
		...
		<div class="message_con">
			<label>设备名称：</label><input name="name" id="edit-frm-name" maxlength="16"  class="required" type="text" placeholder="填车牌号码"><span class="must">*</span>
		</div>
		<div class="message_con">
...
<div id="device-import-dlg" title="批量导入设备" class="simple-dialog"  style="width:650px;height:150px;">
	...
	<div style="width:100%;margin-top:10px;"><a href="http://www.legaoyi.com/file/设备批量导入模板.zip" style="margin-left:20px;color:red;text-decoration:underline;" target="_blak">点击下载导入模板文件</a></div>
</div>
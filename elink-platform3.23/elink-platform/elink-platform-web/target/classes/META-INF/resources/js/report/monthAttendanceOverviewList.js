...
function getQueryUrl() {
	return report_api_server_servlet_path + "/query/attendanceDayReport.json?orderBy=total&desc=true";
}
...
function exportExcel() {
	...
	var url = report_api_server_servlet_path + "/excel/monthAttendance/"
			+ month + ".json?deviceId=" + deviceId;

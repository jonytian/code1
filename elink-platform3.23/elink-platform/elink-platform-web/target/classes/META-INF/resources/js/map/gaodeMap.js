function GaodeMap() {
	/** 调用高德地图api所需的key，需换成自己申请的key* */
	//var KEY = "2744176b837cf4dd6b394952f86b85dd";
	...
	this.loadJScript = function(key) {
		...
		script.src = "http://webapi.amap.com/maps?v=1.4.12&key=" + key
				+ "&callback=initMap";
	...
	this.init = function(container, type) {
		...
		if (type == 1) {
			AMap.plugin([ 'AMap.Autocomplete', 'AMap.GraspRoad','AMap.MarkerClusterer' ],// 'AMap.ToolBar',
			function() {

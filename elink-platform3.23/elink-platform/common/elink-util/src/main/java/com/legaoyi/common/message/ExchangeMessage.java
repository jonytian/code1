package com.legaoyi.common.message;
...
public class ExchangeMessage implements Serializable {
    ...
    /** 终端上传的多媒体消息 **/
    public static final String MESSAGEID_GATEWAY_UP_MEDIA_MESSAGE = "0801";
    ...
    /** 政府平台下发的消息 **/
    public static final String MESSAGEID_EXCHANGE_DOWN_MESSAGE = "9000";

    /** 下级平台上传的消息 **/
    public static final String MESSAGEID_EXCHANGE_UP_MESSAGE = "1000";

    /** 下级平台向网关发送终端链路管理消息 **/
    public static final String MESSAGEID_EXCHANGE_LINK_STATUS_MESSAGE = "1002";

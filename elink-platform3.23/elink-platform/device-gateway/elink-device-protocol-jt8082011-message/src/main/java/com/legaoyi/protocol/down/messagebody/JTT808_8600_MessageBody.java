 ...
 */
@Scope("prototype")
@Component(MessageBody.MESSAGE_BODY_BEAN_PREFIX + "8600_2011" + MessageBody.MESSAGE_BODY_BEAN_SUFFIX)
public class JTT808_8600_MessageBody extends MessageBody {
    ...
    /**
     * 区域项列表，key/val值，如 List<Map<String,Object>> areaList = new
     ...
     * map.put("centerLng", 39.3d);//中心点纬度<br/>
     * map.put("centerLat", 116.3d);//中心点经度<br/>

 ...
 */
@Scope("prototype")
@Component(MessageBody.MESSAGE_BODY_BEAN_PREFIX + "8606_2011" + MessageBody.MESSAGE_BODY_BEAN_SUFFIX)
public class JTT808_8606_MessageBody extends MessageBody {
     ...
     * map.put("lng", 39.867200d);//拐点纬度<br/>
     * map.put("lat", 116.350000d);//拐点经度<br/>

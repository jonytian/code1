...
import com.legaoyi.protocol.upstream.messagebody.Jt808_2019_0700_13H_MessageBody;
 ...
 * @since 2019-05-20
 */
@Component(MessageBodyDecoder.MESSAGE_BODY_DECODER_BEAN_PREFIX + "0700_13H_2019" + MessageBodyDecoder.MESSAGE_BODY_DECODER_BEAN_SUFFIX)
public class Jt808_2019_0700_13H_MessageBodyDecoder extends Jt808_2019_0700_MessageBodyDecoder {

    @Override
    public MessageBody decode(byte[] bytes) throws IllegalMessageException {
        Jt808_2019_0700_13H_MessageBody messageBody = new Jt808_2019_0700_13H_MessageBody();
        ...
        try {
            ...
            while (offset < bytes.length) {
                ...
                sb.append(eventTime).append(",").append(eventType);

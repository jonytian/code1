...
@Component(Constants.ELINK_MESSAGE_STORER_BEAN_PREFIX + "0700" + Constants.ELINK_MESSAGE_STORER_MESSAGE_DAO_BEAN_SUFFIX)
public class JTT808_0700_MessageDaoImpl implements GeneralDao {

    private static final Logger logger = LoggerFactory.getLogger(JTT808_0700_MessageDaoImpl.class);
    ...
    public void batchSave(final List<?> list) throws Exception {
        try {
            mongoDao.batchInsert(list, "jtt808_0700_msg");
        } catch (Exception e) {

...
public class Tjsatl_2017_0200_MessageBody extends MessageBody {
    ...
    public final Map<String, Object> getAdasAlarm() {
        return adasAlarm;
    }

    public final void setAdasAlarm(Map<String, Object> adasAlarm) {
        this.adasAlarm = adasAlarm;
    }

    public final void addAdasAlarm(String key, Object value) {
        if (this.adasAlarm == null) {
            this.adasAlarm = new HashMap<String, Object>();
        }
        this.adasAlarm.put(key, value);
    }

    public final Map<String, Object> getDsmAlarm() {
        return dsmAlarm;
    }

    public final void setDsmAlarm(Map<String, Object> dsmAlarm) {
        this.dsmAlarm = dsmAlarm;
    }

    public final void addDsmAlarm(String key, Object value) {
        if (this.dsmAlarm == null) {
            this.dsmAlarm = new HashMap<String, Object>();
        }
        this.dsmAlarm.put(key, value);
    }

    public final Map<String, Object> getTpmAlarm() {
        return tpmAlarm;
    }

    public final void setTpmAlarm(Map<String, Object> tpmAlarm) {
        this.tpmAlarm = tpmAlarm;
    }

    public final void addTpmAlarm(String key, Object value) {
        if (this.tpmAlarm == null) {
            this.tpmAlarm = new HashMap<String, Object>();
        }
        this.tpmAlarm.put(key, value);
    }

    public final Map<String, Object> getBsdAlarm() {
        return bsdAlarm;
    }

    public final void setBsdAlarm(Map<String, Object> bsdAlarm) {
        this.bsdAlarm = bsdAlarm;
    }

    public final void addBsdAlarm(String key, Object value) {
        if (this.bsdAlarm == null) {
            this.bsdAlarm = new HashMap<String, Object>();
        }
        this.bsdAlarm.put(key, value);
    }

 ...
 * @since 2015-01-30
 */
public class PlatformDownMessageHandler implements MQMessageHandler {

    private final static Logger logger = LoggerFactory.getLogger(PlatformDownMessageHandler.class);
    ...
    public void handle(String message) throws Exception {
        ...
        try {
            ...
            result = 1;
            desc = e.getMessage();
            logger.error("******发送下行消息错误，handle message error,message={}", message, e);

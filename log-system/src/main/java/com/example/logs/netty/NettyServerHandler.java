...
import com.example.logs.netty.util.MsgUtil;
import com.example.logs.netty.util.ServerHandler;
...
//                sendUserNotLoginMsg(ctx);
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof FullHttpRequest) {
            ...
            // 验证token
            JWTVerifier jwtVerifier = JWT.require(Algorithm.HMAC256(imei+projectName)).build();
            try {

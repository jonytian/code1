...
import com.example.logs.entity.WebSocketPerssionVerify;
...
public class ServerHandler {
    ...
    public void saveUserInfo(WebSocketPerssionVerify webSocketPerssionVerify , ChannelHandlerContext ctx){
        ...
        device.setToken(webSocketPerssionVerify.getToken());
            ...
            if (!StringUtils.isEmpty(code)){
                ...
                if (data != null ){
                    if (!StringUtils.isEmpty(imei)){
                       ...
                       String happenTime =  (String) data.get("happenTime");
                       if(StringUtils.isEmpty(happenTime)){
                           throw new Exception("发生时间为空");
                       }

                        if(device !=null){
                            log.info("********************开始保存日志数据******************************");
                            Log exc = new Log();
                            exc.setException((String) data.get("exceptionName"));
                            ...
                            exc.setAndroidVersion((String) data.get("androidVersion"));

	...
	layui.use(['table', 'jquery', 'form', 'util', 'admin'], function () {
		...
		tableIns = table.render({
			...
			cols: [[  //日期，箱号，整机SN，IMEI，ICCID，BT号段，wifi号段
				...
				{
					field: 'exceptionTime', title: '发生时间', width: 200, align: 'center', sort: true, templet: function (d) {
						if (d.exceptionTime == null) {
							return "";
						}
						return util.toDateString(d.exceptionTime, "yyyy-MM-dd HH:mm:ss");
					}
				},
				{

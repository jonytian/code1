 ...
 */
@Scope("prototype")
@Component(MessageBody.MESSAGE_BODY_BEAN_PREFIX + "8001_2011" + MessageBody.MESSAGE_BODY_BEAN_SUFFIX)
public class Jt808_2011_8001_MessageBody extends MessageBody {

    private static final long serialVersionUID = -2901228399265832241L;

    public static final String JTT808_MESSAGE_ID = "8001";

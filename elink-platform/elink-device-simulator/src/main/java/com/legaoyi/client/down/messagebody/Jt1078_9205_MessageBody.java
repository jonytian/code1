 ...
 */
@Scope("prototype")
@Component(MessageBody.MESSAGE_BODY_BEAN_PREFIX + "9205_1078" + MessageBody.MESSAGE_BODY_BEAN_SUFFIX)
public class Jt1078_9205_MessageBody extends MessageBody {

    private static final long serialVersionUID = -2222441901600081391L;

    public static final String JTT808_MESSAGE_ID = "9205";

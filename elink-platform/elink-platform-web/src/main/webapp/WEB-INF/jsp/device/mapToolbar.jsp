...
<ul>
	...
	<!--start  midified by liliang 20200304-->
	...
	<li class="dropdown"><i class="glyphicon glyphicon-remove-circle"></i><a href="javascript:void(0)" id="rail-setting-menu" class="dropdown-toggle" data-toggle="dropdown">电子围栏<b class="caret"></b></a>
		<ul class="dropdown-menu" aria-labelledby="rail-setting-menu">
			<li><a href="javascript:void(0)" onclick="showSetFenceCmdDialog(2,5,'send-set-rail-circle-cmd-dlg')">设置圆形区域</a></li>
			<li><a href="javascript:void(0)" onclick="showDelFenceCmdDialog('8600','send-del-rail-circle-cmd-dlg')">删除圆形区域</a></li>
			<li><a href="javascript:void(0)" onclick="showSetFenceCmdDialog(3,5,'send-set-rail-rectangle-cmd-dlg')">设置矩形区域</a></li>
			<li><a href="javascript:void(0)" onclick="showDelFenceCmdDialog('8602','send-del-rail-rectangle-cmd-dlg')">删除矩形区域</a></li>
			<li><a href="javascript:void(0)" onclick="showSetFenceCmdDialog(4,5,'send-set-rail-polygon-cmd-dlg')">设置多边形区域</a></li>
			<li><a href="javascript:void(0)" onclick="showDelFenceCmdDialog('8604','send-del-rail-polygon-cmd-dlg')">删除多边形区域</a></li>
			<li><a href="javascript:void(0)" onclick="showRouteFenceCmdDialog()">设置线路</a></li> 
			<li><a href="javascript:void(0)" onclick="showDelFenceCmdDialog('8606','send-del-rail-route-cmd-dlg')">删除线路</a></li>
       </ul>
	</li>
	<!--end  midified by liliang 20200304-->
	...
	<li class="dropdown"><i class="glyphicon glyphicon-th-list"></i><a href="javascript:void(0)" onclick="onClickMoreCmd()" class="dropdown-toggle" data-toggle="dropdown">更多<b class="caret"></b></a>
		<ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
               ...
               <!-- modify by tyj-20200307 start -->
                <li toolbar="map-toolbar-cmd-8500"><a href="javascript:void(0)" onclick="showCmdDialog('send-car-lock-cmd-dlg')">加锁</a></li>
                <li toolbar="map-toolbar-cmd-8500"><a href="javascript:void(0)" onclick="showCmdDialog('send-car-unlock-cmd-dlg')">解锁</a></li>
               <!-- modify by tyj-20200307 end -->

...
<div id="gps-history-query-dlg" title="历史轨迹查询" style="width:550px;height:400px;" class="simple-dialog">
	<form id="gps-history-query-dlg-frm">
		...
		<div class="message_con">
			<label>开始时间：</label><input name="startTime" type="text" id="gps-history-query-dlg-frm-startTime" readonly class="required date form_datetime" data-date-format="yyyy-mm-dd hh:mm:00"><span class="must">*</span>
		</div>
		<div class="message_con">
			<label>结束时间：</label><input name="endTime" type="text" id="gps-history-query-dlg-frm-endTime" readonly class="required date form_datetime" data-date-format="yyyy-mm-dd hh:mm:00"><span class="must">*</span>
		</div>
		<div class="message_con">

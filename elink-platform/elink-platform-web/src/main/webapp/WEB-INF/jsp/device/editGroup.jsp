...
<div id="edit-dlg" class="simple-dialog" title="分组信息" style="width:550px;height:350px;">
	<form id="edit-frm" method="post">
		...
		<!-- 修改 by tyj-20200306 -->
		<div class="message_con">
			<label>名称：</label><input name="name" id="edit-frm-name" maxlength="16"  type="text"  class="required" οninput='changed()'>
		</div>
		<!-- 修改 by tyj-20200306 -->
		<div class="message_con">
			<label  style="vertical-align:top;">备注：</label><textarea name="remark" id="edit-frm-remark" style="height:150px" maxlength="20"></textarea>
		</div>

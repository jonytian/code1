...
<body id="home" class="homepage" style=" padding-top:0px;">
					...
					<div style="width:450px;height:200px;margin: auto;top:0;left:0;">
						<div id="login-div" style="margin-top:200px;">
							...
							<div style="width:350px;margin-top:50px;margin-left:30px;">
								<form name="login-frm" id="login-frm" style="margin-left:40px;"><!-- modified by yaojiang.tian at 20200305 -->
									...
									<div class="form-group">
										<input type="text" required placeholder="验证码" class="form-control"
											...
											name="checkCode">&nbsp;&nbsp;&nbsp;&nbsp;
										<img id="captcha" style="cursor:pointer;float:right;margin-top:-25px" title="验证码，看不清楚？请点击刷新验证码 "
											src="<c:url value='/captcha.jpg'/>" width="100" height="35"><!-- modified by yaojiang.tian at 20200305 -->
									</div>
									<button class="btn btn-primary" style="margin-left:100px;margin-top:5px;"
										onclick="javaScript:doLogin();"
										type="button">&nbsp;&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;&nbsp;</button><!-- modified by yaojiang.tian at 20200305 -->
								</form>
							</div>
						</div>
					</div>
	...
	<footer id="footer">
		<div class="container text-center">
			...
			© Copyright 2009-2020,sales@reacheng.com,All rights reserved  版权所有  上海锐承通讯技术有限公司 备案号：沪ICP备16031346号
		</div>
	</footer>
	<!--/#footer-->

...
<script type="text/javascript"
	src="<c:url value='/js/common/timeline.js'/>"></script>
<title>驾驶行程分析</title>
</head>
<body>
	<!--内容部分-->
	<div class="con1 left" id="content-div">
		<div class="right  con_table">
			<div class="table_find">
				<p>
					<label id="search-date-div">日期：</label><input id="search-date" type="text" readonly class="date form_date" data-date-format="yyyy-mm-dd"><!-- modified by yaojiang.tian at 20200305 -->
	...
	<script type="text/javascript" src="<c:url value='/js/report/dailyParkingTimeline.js?v=20190525'/>"></script>
</body>
</html>
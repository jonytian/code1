...
<body>
	...
	<div id="edit-dlg" title="车辆颜色信息" class="simple-dialog" style="width: 500px; height: 200px;">
		<form id="edit-frm" method="post">
			<input name="id" id="edit-frm-id" type="hidden">
			<input name="type" id="edit-frm-type" type="hidden">
			<div class="message_con">
				<label>颜色代码：</label><input name="code" id="edit-frm-code" maxlength="1" type="text" class="required number"><span class="must">*</span>
			</div>
			<div class="message_con">
				<label>颜色名称：</label><input name="content" id="edit-frm-content" maxlength="20" type="text" class="required"><span class="must">*</span>
			</div>
	...
	<script type="text/javascript" src="<c:url value='/js/dictionary/carColorList.js'/>"></script>
</body>
</html>
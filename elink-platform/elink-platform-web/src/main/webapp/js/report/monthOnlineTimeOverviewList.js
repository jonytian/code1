...
function getQueryUrl() {
	return report_api_server_servlet_path + "/query/onlineTimeDayReport.json?orderBy=total&desc=true";
}
...
function exportExcel() {
	...
	var url = report_api_server_servlet_path + "/excel/monthOnlineTime/" + month + ".json?deviceId=" + deviceId;

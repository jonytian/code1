...
function getQueryUrl() {
	return report_api_server_servlet_path+ "/query/accTimeDayReport.json?orderBy=total&desc=true";
}
...
function exportExcel() {
	...
	month = month.replace(/-/g, "");
	 var url = report_api_server_servlet_path+ "/excel/monthAccTime/"+month+".json?deviceId="+deviceId;

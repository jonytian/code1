...
public class MainController {
    ...
    //登录终端类型为手机端
    private static final String TERMINAL_TYPE_PHONE="phone";
    ...
    public void login(HttpServletRequest request, HttpServletResponse response, @RequestBody RequestParams param) throws Exception {
        ...
        //登录终端类型（terminalType = PC 需要校验验证码，terminalType=phone则无需验证验证码）
        String terminalType = (String) form.get("terminalType");
        ...
        if(com.legaoyi.common.util.StringUtils.isNotEmpty(terminalType)&& terminalType.equals(TERMINAL_TYPE_PHONE)) {
            try {

...
function getQueryUrl() {
	...
	return report_api_server_servlet_path + "/deviceDailyAlarmOverviewList/" + date + ".json";
}
...
function exportExcel() {
	...
	var deviceId = "";
	if (query) {
		deviceId = $("#search-deviceId").combobox("getValue");
	}
	var url = report_api_server_servlet_path + "/excel/todayAlarm/" + date + ".json?deviceId=" + deviceId;

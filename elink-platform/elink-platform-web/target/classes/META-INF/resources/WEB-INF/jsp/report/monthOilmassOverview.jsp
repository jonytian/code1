...
<div class="con1" id="content-div">
		<div class="table_find" style="height:55px;">
			<p>
				<label id="search-date-div">日期：</label><input id="search-date" type="text" readonly class="date form_month" data-date-format="yyyy-mm" ><!-- modified by yaojiang.tian at 20200305 -->

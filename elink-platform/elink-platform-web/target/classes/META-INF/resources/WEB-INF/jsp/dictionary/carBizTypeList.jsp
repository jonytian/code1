...
<body>
	...
	<div id="edit-dlg" title="车辆业务类型信息" class="simple-dialog" style="width: 550px; height: 200px;">
	<form id="edit-frm" method="post">
		<input name="id" id="edit-frm-id" type="hidden">
		<input name="type" id="edit-frm-type" type="hidden" value="9">
		<div class="message_con">
			<label>类型代码：</label><input name="code" id="edit-frm-code" maxlength="2" type="text" class="required number"><span class="must">*</span>
		</div>
		<div class="message_con">
			<label>类型名称：</label><input name="content" id="edit-frm-content" maxlength="20" type="text" class="required"><span class="must">*</span>
		</div>
	...
	<script type="text/javascript" src="<c:url value='/js/dictionary/carBizTypeList.js'/>"></script>
</body>
</html>
...
<body>
	...
	<div id="edit-dlg" title="车辆类型信息" class="simple-dialog" style="width: 550px; height: 200px;">
	...
	<script type="text/javascript" src="<c:url value='/js/dictionary/carTypeList.js'/>"></script>
</body>
</html>
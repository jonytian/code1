 ...
 */
@Scope("prototype")
@Component(MessageBody.MESSAGE_BODY_BEAN_PREFIX + "8701_2013" + MessageBody.MESSAGE_BODY_BEAN_SUFFIX)
public class JTT808_8701_2013_MessageBody extends JTT808_8700_2013_MessageBody {
    ...
    public MessageBody invoke(Object o) throws Exception {
        JTT808_8701_2013_MessageBody messageBody = null;
        if (o instanceof String) {
            messageBody = JsonUtil.convertStringToObject((String) o, JTT808_8701_2013_MessageBody.class);
        } else if (o instanceof Map) {
            messageBody = JsonUtil.convertStringToObject(JsonUtil.covertObjectToString(o), JTT808_8701_2013_MessageBody.class);
        }

        try {
            String messageId = MESSAGE_ID.concat("_").concat(messageBody.getCommandWord());
            messageBody = (JTT808_8701_2013_MessageBody) SpringBeanUtil.getMessageBody(messageId, "2013");
            if (o instanceof String) {

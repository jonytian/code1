 ...
 */
@Scope("prototype")
@Component(MessageBody.MESSAGE_BODY_BEAN_PREFIX + "0200_2016" + MessageBody.MESSAGE_BODY_BEAN_SUFFIX)
public class JTT1078_0200_MessageBody extends MessageBody {
    ...
    /** 视频信号丢失报警状态 **/
    @JsonProperty("cameraLoseAlarm")
    private Long cameraLoseAlarm;

    /** 视频信号丢失报警状态 **/
    @JsonProperty("cameraCoverAlarm")
    private Long cameraCoverAlarm;

    /** 存储器故障报警状态 **/
    @JsonProperty("ramAlarm")
    private Integer ramAlarm;

    /** 异常驾驶行为报警状态 **/
    @JsonProperty("drivingAlarm")
    private Integer drivingAlarm;

    /** 疲劳驾驶程度 **/
    @JsonProperty("fatigueAlarm")
    private Integer fatigueAlarm;
    ...
    public final Long getVideoAlarm() {
        return videoAlarm;
    }

    public final void setVideoAlarm(Long videoAlarm) {
        this.videoAlarm = videoAlarm;
    }

    public final Long getCameraLoseAlarm() {
        return cameraLoseAlarm;
    }

    public final void setCameraLoseAlarm(Long cameraLoseAlarm) {
        this.cameraLoseAlarm = cameraLoseAlarm;
    }

    public final Long getCameraCoverAlarm() {
        return cameraCoverAlarm;
    }

    public final void setCameraCoverAlarm(Long cameraCoverAlarm) {
        this.cameraCoverAlarm = cameraCoverAlarm;
    }

    public final Integer getRamAlarm() {
        return ramAlarm;
    }

    public final void setRamAlarm(Integer ramAlarm) {
        this.ramAlarm = ramAlarm;
    }

    public final Integer getDrivingAlarm() {
        return drivingAlarm;
    }

    public final void setDrivingAlarm(Integer drivingAlarm) {
        this.drivingAlarm = drivingAlarm;
    }

    public final Integer getFatigueAlarm() {
        return fatigueAlarm;
    }

    public final void setFatigueAlarm(Integer fatigueAlarm) {

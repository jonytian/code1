...
@Transactional
@Service(Constants.ELINK_MESSAGE_STORER_BEAN_PREFIX + "0801" + Constants.ELINK_MESSAGE_STORER_MESSAGE_SERVICE_BEAN_SUFFIX)
public class JTT808_0801_MessageServiceImpl implements GeneralService {

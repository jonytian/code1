 ...
 * @since 2019-05-20
 */
@Component(MessageBodyEncoder.MESSAGE_BODY_ENCODER_BEAN_PREFIX + "8700_2019" + MessageBodyEncoder.MESSAGE_BODY_ENCODER_BEAN_SUFFIX)
public class Jt808_2019_8700_MessageBodyEncoder implements MessageBodyEncoder {

    @Override
    public byte[] encode(MessageBody messageBody) throws IllegalMessageException {
        try {
            Jt808_2019_8700_MessageBody body = (Jt808_2019_8700_MessageBody) messageBody;
            ...
            bytes = null;
            try {
                String messageId = Jt808_2019_8700_MessageBody.MESSAGE_ID.concat("_").concat(body.getCommandWord()).concat("H");

...
import com.legaoyi.protocol.downstream.messagebody.Jt808_2019_8103_MessageBody;
 ...
 * @since 2019-05-20
 */
@Component(MessageBodyEncoder.MESSAGE_BODY_ENCODER_BEAN_PREFIX + "8103_2019" + MessageBodyEncoder.MESSAGE_BODY_ENCODER_BEAN_SUFFIX)
public class Jt808_2019_8103_MessageBodyEncoder implements MessageBodyEncoder {

    @Override
    public byte[] encode(MessageBody messageBody) throws IllegalMessageException {
        try {
            Jt808_2019_8103_MessageBody body = (Jt808_2019_8103_MessageBody) messageBody;

            Map<String, String> paramList = body.getParamList();
    ...
    static {
        ...
        paramTypeMap.put("001A", "STRING");
        paramTypeMap.put("001B", "DWORD");
        paramTypeMap.put("001C", "DWORD");
        paramTypeMap.put("001D", "STRING");
        ...
        paramTypeMap.put("0023", "STRING");
        paramTypeMap.put("0024", "STRING");
        paramTypeMap.put("0025", "STRING");
        paramTypeMap.put("0026", "STRING");

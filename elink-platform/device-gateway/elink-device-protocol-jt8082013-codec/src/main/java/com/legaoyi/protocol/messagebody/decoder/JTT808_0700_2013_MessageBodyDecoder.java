 ...
 * @since 2015-01-30
 */
@Component(MessageBodyDecoder.MESSAGE_BODY_DECODER_BEAN_PREFIX + "0700_2013" + MessageBodyDecoder.MESSAGE_BODY_DECODER_BEAN_SUFFIX)
public class JTT808_0700_2013_MessageBodyDecoder implements MessageBodyDecoder {
    ...
    public MessageBody decode(byte[] messageBody) throws IllegalMessageException {
        ...
        try {
            ...
            arr = new byte[messageBody.length - offset - 1];
            System.arraycopy(messageBody, offset, arr, 0, arr.length);
            ...
            try {
                ...
                MessageBodyDecoder messageBodyDecoder = SpringBeanUtil.getMessageBodyDecoder(messageId, "2013");

 ...
 * @since 2015-01-30
 */
@Component(MessageBodyDecoder.MESSAGE_BODY_DECODER_BEAN_PREFIX + "0900_2011" + MessageBodyDecoder.MESSAGE_BODY_DECODER_BEAN_SUFFIX)
public class JTT808_0900_MessageBodyDecoder implements MessageBodyDecoder {
    ...
    public MessageBody decode(byte[] messageBody) throws IllegalMessageException {
        ...
        try {
            ...
            // message=ByteUtils.bytesToHexString(arr);
            // 部标测试默认为String类型
            message.setMessage(ByteUtils.bytes2gbk(arr));
            return message;
        } catch (Exception e) {

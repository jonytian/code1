 ...
 */
@Scope("prototype")
@Component(MessageBody.MESSAGE_BODY_BEAN_PREFIX + "0200_2019" + MessageBody.MESSAGE_BODY_BEAN_SUFFIX)
public class Jt808_2019_0200_MessageBody extends MessageBody {
    ...
    public final void setTirePressure(String tirePressure) {
    ...
    public final void setTemperature(Integer temperature) {

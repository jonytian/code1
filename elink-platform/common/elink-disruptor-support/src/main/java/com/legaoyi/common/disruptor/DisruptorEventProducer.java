...
public class DisruptorEventProducer {
    ...
    public DisruptorEventProducer(DisruptorEventConsumer eventConsumer) {
        this(eventConsumer,1024);
    }

    public DisruptorEventProducer(DisruptorEventConsumer eventConsumer, int bufferSize) {
        // The factory for the event
        DisruptorEventFactory factory = new DisruptorEventFactory();

        // Disruptor<DisruptorMessage> disruptor =
        // new Disruptor<DisruptorMessage>(factory, bufferSize,
        ...
        */
        ...
        // Connect the handler
        disruptor.handleEventsWith(new DisruptorEventHandler(eventConsumer));
